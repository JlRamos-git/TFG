...
plt.legend()
plt.title("Modelo SARIMAX v.2 ajustado con variable exógena de sentimiento")
plt.tight_layout()
plt.show()
...
df_resultado.to_excel(r"C:\Users\gonlo\Desktop\TFG\Datos\Resultados\sarimax_sentimiento_v2.xlsx", index=False)
